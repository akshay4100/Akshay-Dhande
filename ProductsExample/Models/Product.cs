...
namespace ProductsExample.Models
{
    public class Product
    {
        ...
        public static List<Product> GetProducts()
        {
            ...
            try
            {
                ...
                while (dr.Read())
                {
                    lstProds.Add(new Product { ProductId = (int)dr["ProductId"], ProductName = (string)dr["ProductName"], Rate = (decimal)dr["Rate"], Description = (string)dr["Description"], CategoryName = (string)dr["CategoryName"] });
                }
                dr.Close();
            }
            catch (Exception ex)
